...
switch ( camLocation ) {
	...
	case ("Hörnum Weststrand"):
		customLogoName = "WWS_Logo_HoernumXMS.png";
		console.log("Hörnum gefunden, CustomLogoName: " + customLogoName + " . ");
	break;

	case ("Sansibar"):
		customLogoName = "WWS_Logo_Sansibar2XMS.png";
