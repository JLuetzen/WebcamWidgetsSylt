...
Das Ergebnis kann sich sehen lassen (Tap oder Click zum Vergrößern-4):
<table class="center">
  <tr>
    <td text align="center"><img src="images/WWSv2-1.jpeg" title="Sylt-Shuttle" onclick="window.open()"></td>
